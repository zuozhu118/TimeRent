...

{
    ...
    public class Config
    {
        ...
        public static string partner = "2088811216459085";
        ...
        public static string private_key = @"uynwvgzz75ks0f1oqflvwubfyuagkjug";
        ...
        //public static string notify_url = "http://121.40.210.7:8076/Alipay/notify_url/notify_url.aspx";
        public static string notify_url = "";
        // 页面跳转同步通知页面路径，需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
        public static string return_url = "http://121.40.210.7:8076/utils/PAY/return_url.aspx";
