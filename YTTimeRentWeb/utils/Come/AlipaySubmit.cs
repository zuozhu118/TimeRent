...
namespace Come.Alipay
{
    ...
    public class Submit
    {
        ...
        //日志存储路径
        public static string LogURL = ConfigurationManager.AppSettings["LogURL"].ToString();
        ...
        private static string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            //打印日志
            //Log.WriteLog("Log", LogURL, "生成的签名："+mysign);
            return mysign;
        }
        ...
        public static string BuildRequest(SortedDictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            ...
            //打印日志 *（可注释）
            //Log.WriteLog("Log", LogURL,"提交的表单:"+ sbHtml.ToString());
